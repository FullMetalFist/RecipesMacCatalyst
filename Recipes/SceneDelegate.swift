...
extension SceneDelegate {
    ...
    private func createThreeColumnSplitViewController() -> UISplitViewController? {
        guard let recipeListViewController = RecipeListViewController.instantiateFromStoryboard(),
              let recipeDetailViewController = RecipeDetailViewController.instantiateFromStoryboard() else { return nil }
